...
public interface CategorizeRangesOfCoordinates {
    List<Coordinate[]> getRangesAboveAndEqualAvarage(CoordinateType coordinateType, Axis axis);
    List<Coordinate[]> getRangesBelowAvarage(CoordinateType coordinateType, Axis axis);
